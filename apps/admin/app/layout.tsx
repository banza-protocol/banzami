    ...
    <html lang="pt" nonce={nonce}>
      ...
      <body>
        ...
        <div role="status" style={{ position: 'fixed', top: 0, left: 0, zIndex: 100, width: '150px', height: '150px', overflow: 'hidden', pointerEvents: 'none' }}>
          <span style={{ position: 'absolute', width: '1px', height: '1px', overflow: 'hidden', clip: 'rect(0 0 0 0)' }}>Ambiente SANDBOX — dinheiro fictício. As operações com dinheiro real estão indisponíveis.</span>
