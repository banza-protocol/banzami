// Watching a Payment Session's status from the Console (ADR-060 §9).
//
// The same protocol @banzami/sdk/realtime speaks, for the Console's own pages:
// the session's short-lived status token goes in the Authorization header of a
