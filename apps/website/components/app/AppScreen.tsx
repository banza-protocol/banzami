  ...
  switch (frame) {
      ...
      return (
        <div className={SCREEN} style={{ background: '#FBF3F1' }}>
          ...
          <div className="flex flex-1 flex-col" style={{ padding: '24px 26px 26px' }}>
            ...
            <p style={{ margin: '11px 0 0', fontSize: 15, fontWeight: 600, lineHeight: 1.4, color: '#746469' }}>É o nome único que as pessoas usam para lhe enviar pagamentos.</p>
      ...
      return (
        <div className={SCREEN} style={{ background: '#FBF3F1' }}>
          ...
          <div className="flex flex-1 flex-col" style={{ padding: '30px 26px 26px' }}>
            ...
            <p style={{ margin: '12px 0 0', fontSize: 15, fontWeight: 600, lineHeight: 1.4, color: '#746469' }}>Entre com a sua conta para continuar.</p>
      ...
      return (
        <div className={SCREEN} style={{ background: '#FBF3F1' }}>
          ...
          <div className="flex flex-1 flex-col items-center" style={{ padding: '10px 24px 22px' }}>
            ...
            <p className="bz-mono" style={{ margin: '9px 0 0', fontSize: 15, fontWeight: 600, color: '#746469' }}>{uHandle}</p>
            ...
            <div className="grid w-full" style={{ marginTop: 'auto', gridTemplateColumns: 'repeat(3,1fr)', gap: 16, maxWidth: 252 }}>
              ...
              <div className="mx-auto flex cursor-pointer items-center justify-center" style={{ width: 64, height: 64 }}>
                <svg width="26" height="26" viewBox="0 0 24 24" fill="none"><path d="M10 5h10a1 1 0 011 1v12a1 1 0 01-1 1H10l-6-7 6-7z" stroke="#746469" strokeWidth="1.7" strokeLinejoin="round" /><path d="M13 9.5l4 5M17 9.5l-4 5" stroke="#746469" strokeWidth="1.7" strokeLinecap="round" /></svg>
              </div>
            </div>
          </div>
        </div>
      ...
      return (
        <div className={SCREEN} style={{ background: '#FBF3F1' }}>
          ...
          <div className="flex flex-1 flex-col items-center text-center" style={{ padding: '18px 24px 22px' }}>
            ...
            <p className="bz-mono" style={{ margin: '3px 0 0', fontSize: 14, fontWeight: 600, color: '#746469' }}>@cantina-alex</p>
            <p style={{ margin: '10px 0 0', fontSize: 14, fontWeight: 600, color: '#746469' }}>Solicitou um pagamento</p>
            ...
            <div className="flex w-full items-center" style={{ marginTop: 20, paddingTop: 18, borderTop: '1px solid #EAD9D7', gap: 12 }}>
              ...
              <div className="text-left">
                <p style={{ margin: 0, fontSize: 12, fontWeight: 600, color: '#746469' }}>Método de pagamento</p>
            ...
            <p style={{ margin: '12px 0 0', fontSize: 12.5, fontWeight: 600, color: '#746469' }}>Pagamento irreversível</p>
          </div>
        </div>
      );
    ...
    case 'partilhar':
      return (
        <div className={SCREEN} style={{ background: '#FBF3F1' }}>
          ...
          <div className="flex flex-1 flex-col overflow-hidden" style={{ padding: '12px 14px 0' }}>
            ...
            <div style={{ marginTop: 10 }}>
              {[
                ...
                { i: (<path d="M4 20l1.3-3.8A7.5 7.5 0 1112 19.5a7.5 7.5 0 01-3.7-1L4 20z" stroke="#12753f" strokeWidth="1.8" strokeLinejoin="round" />), t: 'Partilhar WhatsApp', c: '#12753f', border: false },
              ].map((r, k) => (
          ...
          <div className="shrink-0 text-center" style={{ padding: 13, borderTop: '1px solid #F1E2E0', fontSize: 15, fontWeight: 800, color: '#746469' }}>Fechar</div>
        </div>
      );
        ...
        <div className={SCREEN} style={{ background: '#FBF3F1' }}>
          ...
          <div className="flex flex-1 flex-col" style={{ padding: '14px 24px 26px' }}>
            ...
            <div className="flex items-center justify-between" style={{ background: '#F3E4E2', borderRadius: 18, padding: 16 }}>
              ...
              <span style={{ fontSize: 16, fontWeight: 800, color: '#746469' }}>Kz</span>
            </div>
        ...
        <div className={SCREEN} style={{ background: '#FBF3F1' }}>
          ...
          <div className="flex flex-1 flex-col" style={{ padding: '16px 20px 22px' }}>
            <div className="flex items-center" style={{ background: '#fff', borderRadius: 20, padding: 16, gap: 14, boxShadow: '0 10px 26px -18px rgba(181,16,31,.3)' }}>
              ...
              <div>
                <p style={{ margin: 0, fontSize: 12, fontWeight: 600, color: '#746469' }}>Destinatário</p>
                <p style={{ margin: '2px 0 0', fontSize: 17, fontWeight: 900, color: '#2a2024' }}>Daniel Fonseca</p>
                <p className="bz-mono" style={{ margin: '1px 0 6px', fontSize: 13, fontWeight: 600, color: '#746469' }}>@daniel</p>
            ...
            <div className="text-center" style={{ marginTop: 14, background: '#fff', borderRadius: 20, padding: '22px 18px', boxShadow: '0 10px 26px -18px rgba(181,16,31,.3)' }}>
              <p style={{ margin: 0, fontSize: 13, fontWeight: 600, color: '#746469' }}>Vai enviar</p>
              <p style={{ margin: '8px 0 0', fontSize: 38, fontWeight: 900, letterSpacing: '-.03em', color: '#2a2024' }}>5 000 <span style={{ fontSize: 20, color: '#746469' }}>Kz</span></p>
            ...
            <p className="cursor-pointer text-center" style={{ margin: '14px 0 0', fontSize: 15, fontWeight: 800, color: '#746469' }}>Cancelar</p>
          </div>
        </div>
      );
        ...
        <div className={SCREEN} style={{ background: '#FBF3F1' }}>
          ...
          <div className="flex flex-1 flex-col overflow-hidden" style={{ padding: '12px 20px 0' }}>
            <div>
              ...
              <p style={{ margin: '3px 0 0', fontSize: 13, fontWeight: 600, color: '#746469' }}>QR Code e ligação de pagamento</p>
            </div>
            <div className="shrink-0 text-center" style={{ marginTop: 12, background: '#fff', borderRadius: 22, padding: 18, boxShadow: '0 12px 30px -20px rgba(181,16,31,.3)' }}>
              ...
              <div className="inline-flex items-center" style={{ marginTop: 14, gap: 8, background: '#F3E4E2', padding: '8px 14px', borderRadius: 30 }}>
                ...
                <svg width="16" height="16" viewBox="0 0 24 24" fill="none"><rect x="9" y="9" width="11" height="11" rx="2.5" stroke="#746469" strokeWidth="1.8" /><path d="M5 15V5a2 2 0 012-2h8" stroke="#746469" strokeWidth="1.8" strokeLinecap="round" /></svg>
              </div>
              <p style={{ margin: '10px 0 0', fontSize: 12, fontWeight: 700, color: '#746469' }}>Mostre este código para receber pagamentos</p>
            </div>
          ...
          <div className="flex flex-1 flex-col overflow-hidden" style={{ padding: '12px 20px 0' }}>
            <div className="flex items-start justify-between">
              <div>
                ...
                <p style={{ margin: '3px 0 0', fontSize: 13, fontWeight: 600, color: '#746469' }}>As suas movimentações</p>
              </div>
            ...
            <div className="flex" style={{ marginTop: 14, gap: 9 }}>
              ...
              <span style={{ fontSize: 13, fontWeight: 800, color: '#746469', background: '#fff', padding: '9px 16px', borderRadius: 30 }}>Recebidas</span>
              <span style={{ fontSize: 13, fontWeight: 800, color: '#746469', background: '#fff', padding: '9px 16px', borderRadius: 30 }}>Enviadas</span>
            </div>
            <p style={{ margin: '16px 0 8px', fontSize: 12.5, fontWeight: 700, color: '#746469' }}>27 mai. 2026</p>
    ...
    case 'perfil':
      return (
        <div className={SCREEN} style={{ background: '#FBF3F1' }}>
          <StatusBar time="14:30" />
          <div className="flex flex-1 flex-col overflow-y-auto" style={{ padding: '12px 20px 0' }} tabIndex={0} role="region" aria-label="Perfil (demonstração)">
            <h2 style={{ margin: 0, fontSize: 30, fontWeight: 900, letterSpacing: '-.02em', color: '#2a2024' }}>Perfil</h2>
            <p style={{ margin: '3px 0 0', fontSize: 13, fontWeight: 600, color: '#746469' }}>O seu perfil e definições</p>
            ...
            <div style={{ marginTop: 12, background: '#fff', borderRadius: 20, padding: 16, boxShadow: '0 10px 26px -18px rgba(181,16,31,.3)' }}>
              ...
              <div className="flex items-center justify-between" style={{ marginTop: 12, background: '#F3E4E2', borderRadius: 14, padding: '13px 14px' }}>
                ...
                <svg width="18" height="18" viewBox="0 0 24 24" fill="none"><rect x="9" y="9" width="11" height="11" rx="2.5" stroke="#746469" strokeWidth="1.8" /><path d="M5 15V5a2 2 0 012-2h8" stroke="#746469" strokeWidth="1.8" strokeLinecap="round" /></svg>
              </div>
            </div>
            ...
            <p style={{ margin: '18px 0 8px', fontSize: 12, fontWeight: 800, letterSpacing: '.05em', color: '#746469' }}>CONTA</p>
  ...
  return (
    <div className="flex items-center" style={{ gap: 11, padding: small ? '10px 0' : '11px 0', borderBottom: border ? '1px solid #F4E7E5' : undefined }}>
      ...
      <div className="flex-1">
        ...
        <p style={{ margin: '1px 0 0', fontSize: 11.5, fontWeight: 700, color: '#746469' }}>{kind}</p>
      </div>
      <div className="text-right">
        <p style={{ margin: 0, fontSize: small ? 13.5 : 14, fontWeight: 900, color: amountColor }}>{amount}</p>
        <p style={{ margin: '1px 0 0', fontSize: 11, fontWeight: 700, color: '#746469' }}>{date}</p>
      </div>
    </div>
  );
}
  ...
  return (
    <div className="flex items-center" style={{ gap: 13, padding: '13px 0', borderBottom: border ? '1px solid #F4E7E5' : undefined }}>
      ...
      <div className="flex-1">
        ...
        <p style={{ margin: '1px 0 0', fontSize: 11.5, fontWeight: 700, color: '#746469' }}>{sub}</p>
      </div>
      <svg width="18" height="18" viewBox="0 0 24 24" fill="none"><path d="M9 6l6 6-6 6" stroke="#847074" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" /></svg>
    </div>
  );
}
