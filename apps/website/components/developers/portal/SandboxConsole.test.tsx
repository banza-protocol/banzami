...
describe('Environment cards', () => {
  it('Sandbox available; real-money operations unavailable behind the applicable approvals — never "coming soon"', () => {
    ...
    expect(live).toContain('Operações com dinheiro real');
