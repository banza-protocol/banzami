...
const T = {
  ...
  redDesc: L(
    'Aceda às ferramentas para developers ou fale diretamente com a nossa equipa. A Sandbox pública está disponível; as operações com dinheiro real permanecem indisponíveis nesta fase Beta.',
    'Access the developer tools or talk directly to our team. The public Sandbox is available; real-money operations remain unavailable during this Beta.',
  ),
