            ...
            <div style={{ position: 'relative', minWidth: 0 }}>
              ...
              <div className="bz-phones" style={{ position: 'relative', display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
                <div style={{ position: 'relative' }}>
                  ...
                  <div aria-hidden="true" className="bz-float" style={{ position: 'absolute', zIndex: 3, left: '-40px', bottom: '70px', width: '220px', padding: '14px 16px', borderRadius: '18px', background: '#fff', boxShadow: '0 26px 50px -20px rgba(122,16,22,.45)', animation: 'floaty 6s ease-in-out infinite' }}>
