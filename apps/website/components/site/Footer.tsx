...
//
// PUBLIC-WEBSITE-RELEASE-001: links updated to the canonical IA (Segurança is a
// first-class page, Comerciantes/Sobre labels, FAQ merged into /suporte). The
// visual style is unchanged.
...
// followed by Suporte and the FAQ (which now lives inside Suporte).
const EXPLORE: ExploreLink[] = [
  ...
  { label: 'Perguntas frequentes', href: '/suporte#faq', icon: 'contacto' },
];
