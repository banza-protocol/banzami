        ...
        <div className="max-w-[600px]">
          ...
          <div className="mt-[clamp(18px,2.4vh,26px)] max-w-[560px]">
            ...
            <div className="grid grid-cols-1 gap-2.5 sm:grid-cols-3">
              <a href={APP_WEB} target="_blank" rel="noopener noreferrer" className="flex items-center gap-3.5 rounded-[16px] border border-white/10 bg-ink px-5 py-4 no-underline shadow-[0_10px_26px_-22px_rgba(181,16,31,.3)] transition-transform hover:-translate-y-0.5">
                <span className="grid h-12 w-12 shrink-0 place-items-center rounded-[13px] bg-white/10 text-white">
                  <svg width="33" height="33" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.6" aria-hidden="true"><circle cx="12" cy="12" r="9.2"/><path d="M2.8 12h18.4M12 2.8c2.7 2.5 4.1 5.8 4.1 9.2S14.7 18.7 12 21.2C9.3 18.7 7.9 15.4 7.9 12S9.3 5.3 12 2.8z" strokeLinecap="round" strokeLinejoin="round"/></svg>
                </span>
                <span className="min-w-0 leading-tight"><span className="block text-[14px] font-extrabold text-white">Beta Web</span><span className="block text-[11.5px] font-semibold text-white/55">No browser</span></span>
              </a>
              <button type="button" onClick={() => openFor('IOS')} className="flex items-center gap-3.5 rounded-[16px] border border-white/10 bg-ink px-5 py-4 text-left shadow-[0_10px_26px_-22px_rgba(181,16,31,.3)] transition-transform hover:-translate-y-0.5">
                <span className="grid h-12 w-12 shrink-0 place-items-center rounded-[13px] bg-white/10 text-white">
                ...
                <span className="min-w-0 leading-tight"><span className="block text-[14px] font-extrabold text-white">iPhone</span><span className="block text-[11.5px] font-semibold text-white/55">TestFlight</span></span>
              </button>
              <button type="button" onClick={() => openFor('ANDROID')} className="flex items-center gap-3.5 rounded-[16px] border border-white/10 bg-ink px-5 py-4 text-left shadow-[0_10px_26px_-22px_rgba(181,16,31,.3)] transition-transform hover:-translate-y-0.5">
                <span className="grid h-12 w-12 shrink-0 place-items-center rounded-[13px] bg-white/10 text-white">
                ...
                <span className="min-w-0 leading-tight"><span className="block text-[14px] font-extrabold text-white">Android</span><span className="block text-[11.5px] font-semibold text-white/55">Google Play</span></span>
              </button>
            </div>
