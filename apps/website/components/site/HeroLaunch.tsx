    ...
    <section id="inicio" className="relative overflow-hidden bg-white px-6 pb-10 pt-[96px] md:pt-[104px]">
      ...
      <div className="relative mx-auto grid w-full max-w-container grid-cols-1 items-center gap-y-14 lg:grid-cols-[minmax(0,600px)_minmax(0,1fr)] lg:gap-x-[clamp(40px,4vw,72px)]">
        ...
        <div className="max-w-[600px]">
          ...
          <h1 className="m-0 mt-[clamp(22px,3.2vh,40px)] text-[clamp(38px,3.4vw+1vh,62px)] font-black leading-[1.02] tracking-[-0.03em] text-ink">
          ...
          <p data-testid="home-environment-status" className="m-0 mt-[clamp(14px,2.2vh,24px)] max-w-[520px] text-[12.5px] font-semibold text-ink-muted">
            {sandboxName} disponível com dinheiro fictício. {liveSummaryShort}
          </p>

          {/* CTAs */}
          <div className="mt-[clamp(22px,3.4vh,38px)] flex flex-wrap items-center gap-3">
            <a
              href={APP_WEB}
              target="_blank"
          ...
          {/* Audience cards */}
          <div className="mt-[clamp(24px,3.8vh,44px)] grid max-w-[560px] grid-cols-1 gap-3 sm:grid-cols-2">
            <AudienceCard
          ...
          <div className="mt-[clamp(28px,4.2vh,50px)] max-w-[560px]">
            ...
            <p className="m-0 mt-[clamp(18px,2.8vh,32px)] flex items-center gap-2 text-[12.5px] font-semibold text-ink-muted">
