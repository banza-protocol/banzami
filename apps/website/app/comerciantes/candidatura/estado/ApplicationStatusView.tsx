  ...
  return (
    <Card>
      <div data-testid="application-status" data-status={status.status}>
        <div className="font-mono text-[12.5px] font-bold text-[#746469]">
            ...
            {toSend.map((item) => {
              ...
              return (
                <li key={item.code} className="rounded-[14px] border border-[#f1e3e3] bg-white p-4">
                  ...
                  <div className="mt-0.5 text-[12.5px] font-semibold text-[#746469]">
                  ...
                  />
                  {st.status === 'uploading' && <div className="mt-1 text-[12.5px] font-bold text-[#746469]">A enviar…</div>}
      ...
      <p className="mt-8 text-[13px] font-semibold text-[#746469]">
