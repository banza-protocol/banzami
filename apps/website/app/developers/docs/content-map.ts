...
export const CONTENT_MAP: ContentGroup[] = [
  ...
  { group: 'sandbox-testing', ptRoute: '/docs/testing', enRoute: '/docs/en/testing', ptSource: 'content-pt.tsx', enSource: 'content-en.tsx', ptToken: 'Testar no Sandbox', enToken: 'Testing in the Sandbox' },
