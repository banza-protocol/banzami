...
const COPY = {
  pt: {
    ...
    sandbox: 'Sandbox disponível', live: 'Financial Live indisponível', envLink: 'Sandbox e Live',
  ...
  en: {
    ...
    sandbox: 'Sandbox available', live: 'Financial Live unavailable', envLink: 'Sandbox and Live',
