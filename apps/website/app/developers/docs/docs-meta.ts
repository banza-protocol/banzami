...
export const DOCS_META: Record<string, { pt: [string, string]; en: [string, string] }> = {
  '': { pt: ['Documentação', 'Aceite pagamentos em kwanzas com o Banzami: quickstart, API v1, SDK, webhooks e uma implementação de referência. Sandbox disponível; Financial Live indisponível.'], en: ['Documentation', 'Accept kwanza payments with Banzami: quickstart, API v1, SDK, webhooks and a reference implementation. Sandbox available; Financial Live unavailable.'] },
  ...
  'going-live': { pt: ['Do Sandbox ao Live', 'O estado de Financial Live e a lista de verificação de uma integração pronta.'], en: ['From Sandbox toward Live', 'The status of Financial Live and the checklist for a ready integration.'] },
