      ...
      body: SafeArea(
        child: ListView(
          ...
          children: [
            ...
            // The Personal↔Business switch is NOT in-app: on the web it lives only
            // in the outer web shell (APP-BANZAMI-WEB-DUAL-SHELL-001), and on native
            // mobile it does not exist at all. No cross-app control in app screens.
