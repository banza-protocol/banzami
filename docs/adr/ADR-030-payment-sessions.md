# ADR-030 — Payment Sessions (one financial object, many interfaces)

**Status:** Accepted · **Date:** 2026-06-30 · **Scope:** Operator-level orchestration · **Builds on:** ADR-021, ADR-027, ADR-029, ADR-042
