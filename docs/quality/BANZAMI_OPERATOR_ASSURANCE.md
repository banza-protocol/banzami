...
- **Evidence:** tools/check-sdk-contract.mjs, evidence/assurance/dev-foundation/sdk-clean-install-1783203531.json, evidence/assurance/cap-sdk-001-published-0.13.0-c15d7c74.json, docs/operations/SDK_REGISTRY_OWNERSHIP_AND_RELEASE.md, .github/workflows/sdk-publish.yml, tools/sdk-release.mjs, evidence/assurance/sdk/cap-sdk-001-public-install.json, evidence/assurance/sdk/cap-sdk-001-types-cleanroom-1788629468.json
