...
type LayoutOpts struct {
	Subtitle   string // header subtitle: Business | BANZADMIN | Carteira | Developers
...
// FooterSafety returns the footer safety line for the given kind.
...
func footer(safetyKind string) string {
	return `
...
// RenderLayout renders the full HTML document around a composed body.
