...
const TAGS = /<(H2|H3|CodeBlock|table|Callout|LI|P|UL|ol|CapabilityCards|ErrorCatalogue|HttpClassTable|ScopeTable|ResourceReference|EventReference|Troubleshooting|StageBar|StepCard|NextStepCards|RecipeCard|ChapterFacts|DoDont|\w+Diagram)[\s>/]/g;
