...
abstract class BanzamiColors {
  ...
  static const Color primaryLight = Color(
      0xFFE8434B); // Banzami red — light/highlight — hover, QR centres, secondary fills
  static const Color primaryDark = Color(
      0xFF9A1B22); // Banzami red — dark variant — gradient terminus, pressed state
  static const Color primaryMid =
      Color(0xFFD7242E); // Banzami red — mid gradient stop

  // Secondary — Wine Rose
  static const Color tint =
      Color(0xFFFBD2D0); // secondary — badges, tags, accents

  // Accent — Savanna Gold
  static const Color gold =
      Color(0xFFC89B3C); // accent — highlights, positive emphasis
  static const Color goldLight =
      Color(0xFFD4AF5C); // gold hover / light variant

  // Brand Black
  static const Color black =
      Color(0xFF1A1A1A); // Near Black — primary text, dark surfaces

  // Neutrals — warm-tinted to pair with cherry
  static const Color white = Color(0xFFFFFFFF);
  static const Color offWhite =
      Color(0xFFFCF6F5); // Soft neutral white — main background
  static const Color softNeutral =
      Color(0xFFD8D0CF); // Soft Neutral Shadow — surface gradient end
  ...
  static ThemeData get light {
    ...
    return ThemeData(
      ...
      inputDecorationTheme: InputDecorationTheme(
        ...
        labelStyle:
            BanzamiTextStyles.label.copyWith(color: BanzamiColors.gray600),
        errorStyle:
